...
// 射线更新
void Map::rayCast(double x, double y)
{
...
//     std::cout<<"6666666666666666666"<<std::endl;
    caster.updateMap(cell.first, cell.second, this->grid_map);
    count2show++;
//     std::cout<<count2show<<std::endl;
    if (count2show == 100000)
    {
        this->showMap();
    }
}
